...
package com.wordhunt.wordhunt.view;
...
public class wordhuntView extends View implements Synchronizer.Event, Game.RotateHandler {

	@SuppressWarnings("unused")
	protected static final String TAG = "wordhuntView";
	...
	public wordhuntView(Context context, Game g) {
		super(context);
